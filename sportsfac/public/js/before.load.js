...
$(document).ready(function($) {
    ...
    if( $body.hasClass('navigation-top-header') ) {
        $( ".main-navigation.navigation-top-header" ).load( window.public_path+"external/_navigation.html" );
    }
    else if( $body.hasClass('navigation-off-canvas') ) {
        $( ".main-navigation.navigation-off-canvas" ).load( window.public_path+"external/_navigation.html" );
    }
    mobileNavigation();
    toggleNav();
});
